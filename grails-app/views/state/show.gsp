	...
	<body>
		...
		<div id="show-state" class="content scaffold-show" role="main">
			...
			<ol class="property-list state">
				...
				<g:if test="${stateInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="state.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${stateInstance}" field="description"/></span>
